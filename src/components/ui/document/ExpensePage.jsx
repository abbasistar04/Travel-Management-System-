...
const MOCK_EXPENSES = [
  { id: 1, description: 'Monthly office rent', status: 'Paid', type: 'Rent', value: '50,000 PKR', dueDate: '02/03/2022' },
  { id: 2, description: 'Emirates tickets payment', status: 'Paid', type: 'Supplier Due', value: '50,000 PKR', dueDate: '02/03/2022' },
  { id: 3, description: 'Emirates tickets payment', status: 'Paid', type: 'Supplier Due', value: '50,000 PKR', dueDate: '02/03/2022' },
  { id: 4, description: 'Emirates tickets payment', status: 'Paid', type: 'Supplier Due', value: '50,000 PKR', dueDate: '02/03/2022' },
]
  ...
  return (
    <div className="flex-1 overflow-auto flex flex-col min-h-0 bg-white relative">
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 min-w-0">
        {/* Page header: title + Add Expense button */}
        ...
        {/* Expense Log Table section */}
        <section className="min-w-0 overflow-hidden" aria-labelledby="expense-log-title">
          <div className="overflow-hidden">
            <div
              className="rounded-t-lg px-4 py-3 border border-b-0 border-slate-200"
              style={{ backgroundColor: FILTER_BORDER }}
            >
              <h2 id="expense-log-title" className="text-xl font-bold" style={{ color: BRAND_RED }}>
                Expense Log Table
              </h2>
            </div>
              ...
              <div className="overflow-x-auto min-w-0">
                <table className="w-full text-sm text-left text-slate-700 border-collapse" style={{ minWidth: '800px', tableLayout: 'auto' }}>
                  <thead className="bg-slate-50 border-b border-slate-200 text-slate-600 font-medium">
                    <tr>
                      <th scope="col" className="px-5 py-3 whitespace-nowrap align-middle">Description</th>
                  ...
                  <tbody>
                    {MOCK_EXPENSES.map((row) => (
                      <tr key={row.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                        <td className="px-5 py-3 align-middle">{row.description}</td>
